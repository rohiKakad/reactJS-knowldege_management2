...
class AuthController:
    def __init__(self):
        self.client = MongoClient("mongodb+srv://rohikakad:Shree%402020@cluster0.eah3l.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
        db= self.client["KMT-react"]
        collection = db["user"]
